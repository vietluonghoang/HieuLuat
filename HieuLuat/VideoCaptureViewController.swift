...
class VideoCaptureViewController: UIViewController, AVCaptureFileOutputRecordingDelegate, AVAudioRecorderDelegate, UIScrollViewDelegate {
    ...
    func enableCover(now: Bool) {
        if now {
            //hide the navigation bar when recording
